...
--
ALTER TABLE `payment_portal`
  ADD CONSTRAINT `payment_portal_ibfk_1` FOREIGN KEY (`DOCTOR_ID`) REFERENCES `doctor` (`ID`) ON DELETE CASCADE,
  ADD CONSTRAINT `payment_portal_ibfk_2` FOREIGN KEY (`PATIENT_ID`) REFERENCES `patient` (`ID`) ON DELETE CASCADE;
